...
{
    title:"PizzaX",
    description:"Presenting PizzaX dynamic web app cooked up with the MERN stack, this app not only satisfies tech cravings but also offers a delightful user experience.",
...
{
    title:"Lyrical",
    description:"Introducing Lyrical a web-based app. This app connects to the iTunes API, letting users search for their favorite artists and get a list of their songs. With a sleek and user-friendly interface.",
